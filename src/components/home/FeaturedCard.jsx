...
import { BookOpen, CalendarDays, Users, UserStar } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

const FeaturedCard = ({ tutor }) => {
    const { _id, name, photo, rating, subject, totalSlots, sessionStartDate, hourlyFee } = tutor;
